...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "0.29.0"
  WORKING_DIRECTORY "/home/dariosarra/Documents/Limen/My_Zepio/openjph-bindings/julia/OpenJPH.jl/deps/native_cmake_build/_deps/openjph-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("0.29.0" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/0.29.0")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"0.29.0\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/dariosarra/Documents/Limen/My_Zepio/openjph-bindings/julia/OpenJPH.jl/deps/native_cmake_build/_deps/openjph-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/dariosarra/Documents/Limen/My_Zepio/openjph-bindings/julia/OpenJPH.jl/deps/native_cmake_build/_deps/openjph-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
